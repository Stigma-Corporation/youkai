              ...
              <div class="columns">
                ...
                <div class="column is-6">
                  <div class="content is-medium">
                    <p class="has-text-centered">Общая информация</p>
                    ...
                    <ol>
                      <li>Все вопросы решаются с главой БШ или же замом БШ.</li>
                      ...
                      <li><strong>Запрещаются</strong>: обманы, махинации с денежными валютами, подставления, предательства согильдийцев,
                        ради преследования каких либо алчных целей или личного характера,
